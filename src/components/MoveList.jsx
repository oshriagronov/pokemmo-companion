...
export function MoveList({ title, moves, titleColor, levelColor, itemClass = '' }) {
  ...
  return (
    <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-700">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {moves.map((m, i) => (
          <div key={i} className={`bg-slate-800 p-2 rounded flex flex-col items-center justify-center text-center ${itemClass}`.trim()}>
